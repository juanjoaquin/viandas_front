...
import { getProductCategoryByIdAction } from "@/src/architecture/actions/product-category/get-product-category-by-id.action";
import { TProductCategory } from "@/src/architecture/core/domain/entities/ProductCategory";
import { DeleteProductCategoryDialog } from "./delete-product-category-dialog";
...
export function ProductCategoryID({ category }: ProductCategoryRowActionsProps) {
    const [editOpen, setEditOpen] = useState(false);
    const [deleteOpen, setDeleteOpen] = useState(false);
    const [categoryToEdit, setCategoryToEdit] =
        useState<TProductCategory | null>(null);
    ...
    async function handleEdit() {
        ...
        const result = await getProductCategoryByIdAction(category.id);
